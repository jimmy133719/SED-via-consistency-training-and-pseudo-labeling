...
import pdb
from audio_tagging import Net_resnet
...
if __name__ == '__main__':
    ...
    prediction_dfs.to_csv('unlabel_in_domain_pseudo_weak.tsv', index=False, sep="\t")