...
def get_predictions(model, dataloader, decoder, pooling_time_ratio=1, thresholds=[0.5],
                    median_window=1, save_predictions=None, del_model=False, learned_post=False):
...
def get_f_measure_by_class(torch_model, nb_tags, dataloader_, thresholds_=None, trained=False):
